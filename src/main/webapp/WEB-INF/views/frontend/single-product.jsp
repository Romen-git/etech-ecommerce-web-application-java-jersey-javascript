                    ...
                    <div class="col-md-4">
                        ...
                        <div class="single-sidebar">
                            ...
                            <div class="thubmnail-recent">
                                <img src="${BASE_URL}assets/img/product-thumb-1.jpg" class="recent-thumb" alt="">
                                ...
                                <div class="col-sm-6">
                                    <div class="product-images">
                                        ...
                                        <div class="product-gallery">
                                            <img src="${BASE_URL}assets/img/product-thumb-1.jpg" alt="">
                                            <img src="${BASE_URL}assets/img/product-thumb-2.jpg" alt="">
                                            <img src="${BASE_URL}assets/img/product-thumb-3.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade in active" id="home">
                                                    ...
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam
                                                        ...
                                                        risus, id maximus ex aliquet ut. Suspendisse potenti. Nulla
                                                        varius lectus id turpis dignissim porta. Quisque magna arcu,
                                                        blandit quis felis vehicula, feugiat gravida diam. Nullam nec
                                                        turpis ligula. Aliquam quis blandit elit, ac sodales nisl.
                                                        Aliquam eget dolor eget elit malesuada aliquet. In varius lorem
                                                        lorem, semper bibendum lectus lobortis ac.</p>

                                                    <p>Mauris placerat vitae lorem gravida viverra. Mauris in fringilla
                                                        ex. Nulla facilisi. Etiam scelerisque tincidunt quam facilisis
                                                        lobortis. In malesuada pulvinar neque a consectetur. Nunc
                                                        aliquam gravida purus, non malesuada sem accumsan in. Morbi vel
                                                        sodales libero.</p>
                                                </div>
                                                <div role="tabpanel" class="tab-pane fade" id="profile">
                                                    ...
                                                    <div class="submit-review">
                                                        <p><label for="name">Name</label> <input id="name" name="name"
                                                                                                 type="text"></p>
                                                        <p><label for="email">Email</label> <input id="email"
                                                                                                   name="email"
                                                                                                   type="email"></p>
