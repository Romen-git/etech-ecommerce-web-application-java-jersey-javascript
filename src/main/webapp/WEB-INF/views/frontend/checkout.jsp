                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="shopping-item">
                            <a href="${BASE_URL}cart">Cart - <span class="cart-amunt">$100</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">5</span></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="single-sidebar">
                            ...
                            <ul>
                                <li><a href="${BASE_URL}single-product">Sony Smart TV - 2015</a></li>
                                <li><a href="${BASE_URL}single-product">Sony Smart TV - 2015</a></li>
                                <li><a href="${BASE_URL}single-product">Sony Smart TV - 2015</a></li>
                                <li><a href="${BASE_URL}single-product">Sony Smart TV - 2015</a></li>
                                <li><a href="${BASE_URL}single-product">Sony Smart TV - 2015</a></li>
