                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="shopping-item">
                            <a href="${BASE_URL}cart">Cart - <span class="cart-amunt">$800</span> <i
                ...
                <div class="row">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="${BASE_URL}cart">Cart</a></li>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="single-sidebar">
                            ...
                            <div class="thubmnail-recent">
                                ...
                                <h2><a href="${BASE_URL}single-product">Sony Smart TV - 2015</a></h2>
                            ...
                            <div class="woocommerce">
                                    ...
                                    <table cellspacing="0" class="shop_table cart">
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                <a href="${BASE_URL}single-product"><img width="145" height="145"
                                                                                         alt="poster_1_up"
                                                                                         class="shop_thumbnail"
                                                                                         src="${BASE_URL}assets/img/product-thumb-2.jpg"></a>
                                            </td>

                                            <td class="product-name">
                                                <a href="${BASE_URL}single-product">Ship Your Idea</a>
                                            </td>
                                ...
                                <div class="cart-collaterals">
                                    ...
                                    <div class="cross-sells">
                                        ...
                                        <ul class="products">
                                            <li class="product">
                                                <a href="${BASE_URL}single-product">
                                                    <img width="325" height="325" alt="T_4_front"
                                                         class="attachment-shop_catalog wp-post-image"
                                                         src="${BASE_URL}assets/img/product-2.jpg">
                                                    <h3>Ship Your Idea</h3>
                                                    <span class="price"><span class="amount">£20.00</span></span>
                                                </a>

                                                <a class="add_to_cart_button" data-quantity="1" data-product_sku=""
                                                   data-product_id="22" rel="nofollow" href="${BASE_URL}single-product">Select
                                                    options</a>
                                            </li>
                                            ...
                                            <li class="product">
                                                <a href="${BASE_URL}single-product">
                                                    <img width="325" height="325" alt="T_4_front"
                                                         class="attachment-shop_catalog wp-post-image"
                                                         src="${BASE_URL}assets/img/product-4.jpg">
                                                    <h3>Ship Your Idea</h3>
                                                    <span class="price"><span class="amount">£20.00</span></span>
                                                </a>
